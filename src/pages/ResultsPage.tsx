...
import { Award, Star, TrendingUp, Target, BookOpen, Trophy, Medal, Zap, BanknoteIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-black text-gray-900 mb-6">
            Teach Nation <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Achievers</span>
          </h1>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Celebrating the outstanding achievements of our students in CBSE, ICSE board examinations 
            and Banking competitive tests.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {[
            { icon: Star, label: "School Toppers", value: "45+", color: "from-amber-400 to-orange-500", bg: "bg-amber-500" },
            { icon: TrendingUp, label: "Above 90%", value: "82%", color: "from-green-400 to-emerald-500", bg: "bg-green-500" },
            { icon: Target, label: "Success Rate", value: "96%", color: "from-blue-400 to-cyan-500", bg: "bg-blue-500" },
            { icon: BanknoteIcon, label: "Banking Selections", value: "50+", color: "from-purple-400 to-pink-500", bg: "bg-purple-500" },
          ].map((stat, i) => (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {TOPPERS.map((t, idx) => (
            <Card 
              key={idx} 
              className="hover:shadow-2xl transition-all duration-500 border border-gray-200 bg-white/80 backdrop-blur-sm group hover:border-blue-300 rounded-3xl overflow-hidden"
            >
              {/* Achievement Ribbon */}
              {t.rank && t.rank <= 3 && (
              ...
              <CardHeader className="pb-4 pt-6">
                <div className="flex items-start justify-between mb-3">
                  <Badge className="bg-blue-100 text-blue-700 border border-blue-200 text-sm font-semibold px-3 py-1 rounded-full">
                    {t.year}
                  </Badge>
                  {t.rank && (
                ...
                <CardTitle className="text-2xl font-bold text-gray-900 group-hover:text-blue-700 transition-colors leading-tight">
                  {t.name}
                </CardTitle>
              ...
              <CardContent>
                <div className="flex items-center gap-4 mb-4">
                  <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white text-lg font-bold px-5 py-3 rounded-2xl shadow-lg">
                    {t.score}
                  </div>
                  {t.subject && (
                    <div className="text-sm text-blue-700 font-semibold bg-blue-50 px-3 py-2 rounded-lg border border-blue-200">
                      🏆 {t.subject}
                    </div>
                  )}
                </div>
        ...
        <div className="bg-gradient-to-br from-white to-blue-50 rounded-3xl p-10 shadow-2xl border border-blue-100 mb-16">
          <div className="text-center mb-10">
            <h2 className="text-4xl font-black text-gray-900 mb-4">
              Consistent <span className="text-blue-600">Excellence</span>
            </h2>
            <p className="text-gray-700 text-lg max-w-3xl mx-auto leading-relaxed">
              Year after year, Teach Nation students demonstrate exceptional performance 
              in board examinations and competitive tests, setting new benchmarks of success.
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8 text-center">
            {[
              { value: "94%", title: "Class 12 Average", subtitle: "CBSE & ICSE Results", icon: "🎓", color: "text-blue-600" },
              { value: "92%", title: "Class 10 Average", subtitle: "CBSE & ICSE Results", icon: "📚", color: "text-green-600" },
              { value: "50+", title: "Banking Selections", subtitle: "SBI Clerk & IBPS", icon: "🏦", color: "text-amber-600" },
            ].map((stat, index) => (
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900 rounded-3xl p-12 text-white shadow-2xl">
          ...
          <div className="relative text-center">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              Join the legacy of Teach Nation achievers. With expert mentorship, comprehensive study material, 
              and proven teaching methodologies, your success is our mission.
            </p>
